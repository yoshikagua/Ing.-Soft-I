...
__export(index_exports, {
  ...
  download: () => import_chunk_Q5QFYZJH.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_Q5QFYZJH.getBinaryName,
  getCacheDir: () => import_chunk_G7EM4XDM.getCacheDir,
  getProxyAgent: () => import_chunk_AGZFDFHU.getProxyAgent,
  getVersion: () => import_chunk_Q5QFYZJH.getVersion,
  maybeCopyToTmp: () => import_chunk_Q5QFYZJH.maybeCopyToTmp,
  overwriteFile: () => import_chunk_G7EM4XDM.overwriteFile,
  plusX: () => import_chunk_Q5QFYZJH.plusX,
  vercelPkgPathRegex: () => import_chunk_Q5QFYZJH.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_Q5QFYZJH = require("./chunk-Q5QFYZJH.js");
